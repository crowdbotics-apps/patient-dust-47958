"""
Django settings for patient_dust_47958 project.
...
ROOT_URLCONF = 'patient_dust_47958.urls'
...
WSGI_APPLICATION = 'patient_dust_47958.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_dust_47958 API",
    "DESCRIPTION": "API documentation for patient_dust_47958 App",
    "VERSION": "v1",
}
